...
- 🗺️ **GitHub Planner**: Creates issues aligned with project goals
- 🔧 **GitHub Issue Fixer**: Tackles your issues in dedicated Pull Requests
- 🔁 **GitHub Pull Request Fixer**: Addresses feedback within Pull Requests

### 1. 🗺️ [GitHub Planner](loachbot-github-planner/SKILL.md)
...
2. ⬇️ Download the folders into `~/.claude/skills`, or use your favourite SKILL installation method, like `gh`:
   ```bash
...
- ✍️ **Commit Style**: Rely on your global settings for commit messages and attribution
